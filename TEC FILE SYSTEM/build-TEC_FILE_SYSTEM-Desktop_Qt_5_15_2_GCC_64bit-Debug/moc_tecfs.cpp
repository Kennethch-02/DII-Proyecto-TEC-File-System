...
QT_MOC_LITERAL(4, 21, 9), // "r_message"
QT_MOC_LITERAL(5, 31, 18), // "on_connect_clicked"
QT_MOC_LITERAL(6, 50, 10), // "Append_CMD"
QT_MOC_LITERAL(7, 61, 19) // "Interpreter_Message"

    },
    "TECFS\0update\0\0change\0r_message\0"
    "on_connect_clicked\0Append_CMD\0"
    "Interpreter_Message"
};
...
void TECFS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->r_message(); break;
        case 3: _t->on_connect_clicked(); break;
        case 4: _t->Append_CMD(); break;
        case 5: _t->Interpreter_Message(); break;
        default: ;
        }
        ...
        {
            using _t = void (TECFS::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TECFS::r_message)) {
                *result = 2;
                return;
            }
        }
